...
{
    public partial class FFTPhaseForm : Form
    {
        MainForm main;
        double[] scaleBuf = new double[] { 1.10, -0.05 };

        public FFTPhaseForm(MainForm M)
        {
            InitializeComponent();
        ...
        private PlotModel Prepare_Plot()
        {
            ...
            model.Series.Add(new LineSeries { Title = "Фазы", StrokeThickness = 1, MarkerType = MarkerType.Diamond });
